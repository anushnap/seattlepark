...
# parking street.
#   e.x.: If the start and end coordinates of the street are (1,2) and (3,4), 
#   where 1 and 3 are latitude and 2 and 4 are longitude. Then the coordinates 
#   field will look like [[1,3], [2,4]]. This is the format which plotly uses 
#   to show a street on a map.
...
class ParkingSpot:
    def __init__(self, distance, coordinates, 
                street_name, street_lat_mid, street_lon_mid):
